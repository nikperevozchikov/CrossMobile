...
namespace UberClone.ViewModels
{
    public class MapPageViewModel : INotifyPropertyChanged
    {
        ...
        void FillRecentPlacesList()
        {
            ...
            {
                {new GooglePlaceAutoCompletePrediction(){ PlaceId="ChIJq0wAE_CJr44RtWSsTkp4ZEM", StructuredFormatting=new StructuredFormatting(){ MainText="ЦУМ", SecondaryText="ул. Вилоновская, 138" } } },
                {new GooglePlaceAutoCompletePrediction(){ PlaceId="ChIJq0wAE_CJr44RtWSsTkp4ZEM", StructuredFormatting=new StructuredFormatting(){ MainText="Парк им. Ю. Гагарина", SecondaryText="ул. Советской Армии, 181В" } } },
                {new GooglePlaceAutoCompletePrediction(){ PlaceId="ChIJm02ImNyJr44RNs73uor8pFU", StructuredFormatting=new StructuredFormatting(){ MainText="TЦ Аврора", SecondaryText="ул. Авроры, 40" } } },
            };
